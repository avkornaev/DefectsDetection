...
DR=0;%диапазон номеров измерений [] или 0, если весь диап.
 ...
 l =400;% кол-во измерений 1 фактора для 1 обучающей выборки
 n =1200;% кол-во обучающих выборок из 1 опыта
...
%FFTVibro2- (4);
%FFTVibro3- (5);
NmeasBruel=[1 0 1 0 0];%0 - измерение выкл., 1- измерение вкл.
